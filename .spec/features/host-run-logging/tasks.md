...
## T-005 — Implementar e testar o codec binário tipado [pendente]
...
## T-006 — Implementar o logger assíncrono e os testes concorrentes [pendente]

- Refs: US-008, AC-018, AC-019, AC-020, AC-021, US-010, AC-026
- Arquivos: include/binary_logger.h, src/binary_logger.c, tests/test_binary_logger.c, tests/test_sample_queue.c, tests/CMakeLists.txt, CMakeLists.txt
...
## T-007 — Implementar e testar a conversão pós-execução para CSV [pendente]
...
## T-008 — Integrar logging binário ao runner e ao resultado final [pendente]

- Refs: US-008, AC-018, AC-019, AC-020, US-010, AC-025, AC-026
- Arquivos: include/app_config.h, include/common.h, include/rt_simulation.h, src/app_config.c, src/main.c, src/rt_simulation.c, src/csv_logger.c, include/csv_logger.h, CMakeLists.txt, tests/test_run_logging.c, tests/CMakeLists.txt, test/run_spec_tests.js
...
## T-009 — Atualizar SDD, rastreabilidade e evidência da TASK-002 [pendente]

- Refs: US-007, AC-015, AC-016, AC-017, US-008, AC-018, AC-019, AC-020, AC-021, US-009, AC-022, AC-023, AC-024, US-010, AC-025, AC-026
- Arquivos: README.md, docs/README.md, docs/contracts/interfaces.md, docs/plan.md, docs/tasks/TASK-002.md, docs/traceability.md, docs/quality-gates.md, docs/sdd-versions.md, docs/evidence/host-run-logging-2026-09-07.md, .spec/features/host-run-logging/spec.md, .spec/features/host-run-logging/tasks.md, test/sdd-versioning.spec.test.js, onpspec.config.json
