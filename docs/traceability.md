...
| REQ-F-20 | ARCH-IO / IF-DAQ | TASK-007, TASK-008 | src/daq_state_control.c; src/daq_xrce_udp_bridge.c; src/daqc_ros_control.c; firmware/daqc_esp32/main/daqc_ros.c; firmware/daqc_esp32/main/daqc_control.c | P | V-F-20 / HOST + HIL | [host-rcl-control-2026-09-10](evidence/host-rcl-control-2026-09-10.md): nó `rcl` HOST inicia e publica setup em teste; [host-xrce-udp-bridge-2026-09-10](evidence/host-xrce-udp-bridge-2026-09-10.md): ponte MID 04↔UDP em loopback; Agent, sessão XRCE, CH340, DAQC e HIL pendentes |
