...
| REQ-F-18 | ARCH-IO / IF-DAQ | TASK-007 | src/daq_state_control.c; src/daq_coordinator.c | P | V-F-18 / HOST + bancada | [host-daq-state-control-2026-09-10](evidence/host-daq-state-control-2026-09-10.md): CONFIG/STATUS e timeout em memória; sem TTY físico ou bancada |
...
| REQ-F-20 | ARCH-IO / IF-DAQ | TASK-007, TASK-008 | src/daq_state_control.c; src/daq_xrce_udp_bridge.c; firmware/daqc_esp32/main/daqc_ros.c; firmware/daqc_esp32/main/daqc_control.c | P | V-F-20 / HOST + HIL | [host-xrce-udp-bridge-2026-09-10](evidence/host-xrce-udp-bridge-2026-09-10.md): ponte MID 04↔UDP em loopback no HOST; [micro-ros-agent-udp-host-2026-09-10](evidence/micro-ros-agent-udp-host-2026-09-10.md): Agent UDP disponível em ambiente temporário; sem sessão XRCE, CH340, DAQC ou HIL |
