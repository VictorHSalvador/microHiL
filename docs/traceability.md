...
| REQ-F-20 | ARCH-IO / IF-DAQ | TASK-007, TASK-008 | src/daq_state_control.c; firmware/daqc_esp32/main/daqc_ros.c; firmware/daqc_esp32/main/daqc_control.c | P | V-F-20 / HOST + HIL | [host-daq-state-control-2026-09-10](evidence/host-daq-state-control-2026-09-10.md): transições HOST em memória; firmware compilado separadamente, sem Agent, enlace ou HIL |
