...
| TASK-008 | Firmware DAQC/perfil físico; F-02/03/18/19/20/27, NF-16/17/19 | TARGET, TASK-007 e ESP-IDF v5.2.6 disponíveis | Boot, ADC/DAC/digital/PWM, dois núcleos, parser sem CRC, perda sem replay, DISABLE após 60 s sem READ_ACK e interface `/daqc_*`; bancada com instrumentos | Em andamento: mapa ESP32, `profile_id = 1`, layouts DATA 28/21 bytes e configuração ADC/PWM por setup confirmados; interfaces ROS ampliadas e compiladas no HOST; cliente micro-ROS e ensaio de enlace pendentes |
