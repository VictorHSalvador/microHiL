...
| TASK-006 | Perfil abstrato, inputs virtuais e DAQC mock; F-02/03/17/21/23/24/27, NF-14/16/19/31 | Contrato interno e TASK-003; perfil sintético rotulado | Mapa tipado rejeita incompatibilidades; snapshot consistente; mock injeta idade/falha sem ser confundido com bancada | Em andamento: carregador YAML versionado valida perfil ESP32, canais, tipos e transforms em HOST; resolução contra FMU, construção de schemas e mock pendentes |
