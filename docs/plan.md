...
| TASK-008 | Firmware DAQC/perfil físico; F-02/03/18/19/20/27, NF-16/17/19 | TARGET, TASK-007 e ESP-IDF v5.2.6 disponíveis | Boot, ADC/DAC/digital/PWM, dois núcleos, parser sem CRC, perda sem replay e DISABLE após 60 s sem READ_ACK; bancada com instrumentos | Em andamento: compatibilidade declarada para ESP32 clássico/ESP-IDF 5.2 confirmada; build integrado e validação física pendentes |
