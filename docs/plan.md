...
| TASK-008 | Firmware DAQC/perfil físico; F-02/03/18/19/20/27, NF-16/17/19 | TARGET, TASK-007 e ESP-IDF v5.2.6 disponíveis | Boot, ADC/DAC/digital/PWM, dois núcleos, parser sem CRC, perda sem replay, DISABLE após 60 s sem READ_ACK e interface `/daqc_*`; bancada com instrumentos | Em andamento: build ESP-IDF/micro-ROS concluído em HOST e perfil físico ADC/DAC/digital/PWM materializado; cliente micro-ROS, aplicação ROS de setup/state/errors e ensaio de enlace pendentes |
