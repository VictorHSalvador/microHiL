...
- **Interface:** vetores de tipos/byte order/layout; fragmentação/agregação, ruído, tamanho inválido, frame parcial, timeout, repetido/antigo/gap/wrap e versão de perfil incompatível. Testar Bulk/libusb, MID 04 XRCE best effort, SYNC 0x7259, DATA de até 261 bytes, STATUS somente CONFIG, payload contendo SYNC e DISABLE sob streaming. Nenhum caso espera CRC, NACK, retransmissão ou replay.
